...
export CLOUD_SQL_INSTANCE="${CLOUD_SQL_INSTANCE:-r2c-tracker-pilot:us-west1:r2c-pilot-pg}"
...
export TRACKER_API_KEY_SECRET_NAME="${TRACKER_API_KEY_SECRET_NAME:-r2c-tracker-api-key}"
...
export CONTROL_PLANE_MODE="${CONTROL_PLANE_MODE:-simulation}"
